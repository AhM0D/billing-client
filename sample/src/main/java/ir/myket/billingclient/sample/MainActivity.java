...
package ir.myket.billingclient.sample;
...
public class MainActivity extends Activity {
    ...
    IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
        ...
        public void onQueryInventoryFinished(IabResult result, Inventory inv) {
            ...
            Purchase infiniteGasPurchase = inv.getPurchase(SKU_INFINITE_GAS);
            ...
            Purchase gasPurchase = inv.getPurchase(SKU_GAS);
            if (gasPurchase != null && verifyDeveloperPayload(gasPurchase)) {
                Log.d(TAG, "We have gas. Consuming it.");
                mHelper.consumeAsync(inv.getPurchase(SKU_GAS), mConsumeFinishedListener);
                return;
            }
    ...
    public void onBuyGasButtonClicked(View arg0) {
        ...
        mHelper.launchPurchaseFlow(this, SKU_GAS, mPurchaseFinishedListener, payload);
    }
    ...
    public void onInfiniteGasButtonClicked(View arg0) {
        ...
        mHelper.launchPurchaseFlow(this,
                SKU_INFINITE_GAS, IabHelper.ITEM_TYPE_SUBS, mPurchaseFinishedListener, payload);
    }
